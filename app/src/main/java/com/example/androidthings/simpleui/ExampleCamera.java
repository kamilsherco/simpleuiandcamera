...
public class ExampleCamera {
    private static final String TAG = ExampleCamera.class.getSimpleName();
    ...
    private ExampleCamera() {
    }

    private static class InstanceHolder {
        private static ExampleCamera mCamera = new ExampleCamera();
    }

    public static ExampleCamera getInstance() {
